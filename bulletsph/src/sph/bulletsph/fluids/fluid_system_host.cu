...
void FluidClearCUDA ()
{
	//_LogFunctionCall("FluidClearCUDA()");
...
{	
	//_LogFunctionCall("FluidSetupCUDA()");
...
{
	//_LogFunctionCall("FluidParamCUDA()");
...
{
	//_LogFunctionCall("TransferToCUDA()");
...
{
	//_LogFunctionCall("TransferFromCUDA()");
...
{
	//_LogFunctionCall("Grid_InsertParticlesCUDA()");
...
{
	//_LogFunctionCall("SPH_ComputePressureCUDA()");
...
{
	//_LogFunctionCall("SPH_ComputeForceCUDA()");
	//-- standard force
...
{
	//_LogFunctionCall("SPH_AdvanceCUDA()");
